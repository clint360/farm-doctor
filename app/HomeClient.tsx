        ...
        <div className="c">
          <div className="hero-content">
            ...
            <div className="hero-btns">
              <a href="https://wa.me/237693477577" className="btn btn-wa" target="_blank" rel="noopener">
                <WhatsAppSvgInline />
            ...
            <div className="hero-ch">
              ...
              <div className="ch-pills">
                <a href="https://wa.me/237693477577" className="ch-pill" target="_blank">
                ...
                <a href="https://t.me/Farm_doctor_bot" className="ch-pill" target="_blank">
        ...
        <div className="c">
          ...
          <div className="cg sg">
            <div className="cc rv">
              ...
              <h3>WhatsApp</h3>
              <div className="cc-num">+237 6 93 47 75 77</div>
              <p>{t("ch.wa.d")}</p>
              <a href="https://wa.me/237693477577" className="cc-link" target="_blank">{t("ch.wa.l")}</a>
            </div>
            <div className="cc rv">
              <div className="cc-ic tg"><TelegramIcon /></div>
              <h3>Telegram</h3>
              <div className="cc-num">@Farm_doctor_bot</div>
              <p>{t("ch.tg.d")}</p>
              <a href="https://t.me/Farm_doctor_bot" className="cc-link" target="_blank">{t("ch.tg.l")}</a>
            </div>
            <div className="cc rv">
              <div className="cc-ic cl"><PhoneIcon /></div>
              <h3>{t("ch.cl.t")}</h3>
              <div className="cc-num">+237 6 80 61 23 60</div>
              <p>{t("ch.cl.d")}</p>
        ...
        <div className="c">
          <div className="cta-c rv">
            ...
            <div className="cta-btns">
              <a href="https://wa.me/237693477577" className="btn btn-wa" target="_blank">
                <WhatsAppSvgInline />
                <span>{t("cta.btn1")}</span>
              </a>
              <a href="https://t.me/Farm_doctor_bot" className="btn btn-o" target="_blank">{t("cta.btn2")}</a>
            </div>
          </div>
        </div>
      </section>
