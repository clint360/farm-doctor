...
export const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "237693477577";
export const WHATSAPP_DISPLAY = process.env.NEXT_PUBLIC_WHATSAPP_DISPLAY || "+237 6 93 47 75 77";
export const CALL_NUMBER = process.env.NEXT_PUBLIC_CALL_NUMBER || "237680612360";
export const CALL_DISPLAY = process.env.NEXT_PUBLIC_CALL_DISPLAY || "+237 6 80 61 23 60";
export const COMPANY_PHONE = process.env.NEXT_PUBLIC_COMPANY_PHONE || "237693477577";
export const COMPANY_DISPLAY = process.env.NEXT_PUBLIC_COMPANY_DISPLAY || "+237 6 93 47 75 77";
