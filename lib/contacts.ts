...
export const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "+237682642553";
export const WHATSAPP_DISPLAY = process.env.NEXT_PUBLIC_WHATSAPP_DISPLAY || "237682642553";
export const CALL_NUMBER = process.env.NEXT_PUBLIC_CALL_NUMBER || "+237682642553";
export const CALL_DISPLAY = process.env.NEXT_PUBLIC_CALL_DISPLAY || "/call";
export const COMPANY_PHONE = process.env.NEXT_PUBLIC_COMPANY_PHONE || "+237680612360";
export const COMPANY_DISPLAY = process.env.NEXT_PUBLIC_COMPANY_DISPLAY || "+237680612360";
